...
func (_u *AppSettingUpdate) Modify(modifiers ...func(u *sql.UpdateBuilder)) *AppSettingUpdate {
...
// Modify adds a statement modifier for attaching custom logic to the UPDATE statement.
func (_u *AppSettingUpdateOne) Modify(modifiers ...func(u *sql.UpdateBuilder)) *AppSettingUpdateOne {
	_u.modifiers = append(_u.modifiers, modifiers...)
	return _u
}
