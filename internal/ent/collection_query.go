...
func (_q *CollectionQuery) QueryTrip() *TripQuery {
...
func (_q *CollectionQuery) QueryAssets() *AssetQuery {
...
func (_q *CollectionQuery) QueryShares() *ShareLinkQuery {
...
func (_q *CollectionQuery) QueryCollectionAssets() *CollectionAssetQuery {
...
func (_q *CollectionQuery) WithTrip(opts ...func(*TripQuery)) *CollectionQuery {
	query := (&TripClient{config: _q.config}).Query()
...
func (_q *CollectionQuery) WithAssets(opts ...func(*AssetQuery)) *CollectionQuery {
	query := (&AssetClient{config: _q.config}).Query()
	for _, opt := range opts {
		opt(query)
	}
...
func (_q *CollectionQuery) WithShares(opts ...func(*ShareLinkQuery)) *CollectionQuery {
	query := (&ShareLinkClient{config: _q.config}).Query()
	for _, opt := range opts {
		opt(query)
	}
...
func (_q *CollectionQuery) WithCollectionAssets(opts ...func(*CollectionAssetQuery)) *CollectionQuery {
	query := (&CollectionAssetClient{config: _q.config}).Query()
	for _, opt := range opts {
		opt(query)
	}
...
func (_q *CollectionQuery) sqlAll(ctx context.Context, hooks ...queryHook) ([]*Collection, error) {
	...
	if query := _q.withTrip; query != nil {
		if err := _q.loadTrip(ctx, query, nodes, nil,
			func(n *Collection, e *Trip) { n.Edges.Trip = e }); err != nil {
			return nil, err
		}
	}
	if query := _q.withAssets; query != nil {
		if err := _q.loadAssets(ctx, query, nodes,
			func(n *Collection) { n.Edges.Assets = []*Asset{} },
			func(n *Collection, e *Asset) { n.Edges.Assets = append(n.Edges.Assets, e) }); err != nil {
			return nil, err
		}
	}
	if query := _q.withShares; query != nil {
		if err := _q.loadShares(ctx, query, nodes,
			func(n *Collection) { n.Edges.Shares = []*ShareLink{} },
			func(n *Collection, e *ShareLink) { n.Edges.Shares = append(n.Edges.Shares, e) }); err != nil {
			return nil, err
		}
	}
	if query := _q.withCollectionAssets; query != nil {
		if err := _q.loadCollectionAssets(ctx, query, nodes,
			func(n *Collection) { n.Edges.CollectionAssets = []*CollectionAsset{} },
			func(n *Collection, e *CollectionAsset) {
				n.Edges.CollectionAssets = append(n.Edges.CollectionAssets, e)
			}); err != nil {
			return nil, err
		}
	}
...
func (_q *CollectionQuery) loadTrip(ctx context.Context, query *TripQuery, nodes []*Collection, init func(*Collection), assign func(*Collection, *Trip)) error {
...
func (_q *CollectionQuery) loadAssets(ctx context.Context, query *AssetQuery, nodes []*Collection, init func(*Collection), assign func(*Collection, *Asset)) error {
	edgeIDs := make([]driver.Value, len(nodes))
	byID := make(map[int]*Collection)
	nids := make(map[int]map[*Collection]struct{})
	...
	query.Where(func(s *sql.Selector) {
		joinT := sql.Table(collection.AssetsTable)
		s.Join(joinT).On(s.C(asset.FieldID), joinT.C(collection.AssetsPrimaryKey[1]))
		s.Where(sql.InValues(joinT.C(collection.AssetsPrimaryKey[0]), edgeIDs...))
		columns := s.SelectedColumns()
		s.Select(joinT.C(collection.AssetsPrimaryKey[0]))
...
func (_q *CollectionQuery) loadShares(ctx context.Context, query *ShareLinkQuery, nodes []*Collection, init func(*Collection), assign func(*Collection, *ShareLink)) error {
	...
	if len(query.ctx.Fields) > 0 {
		query.ctx.AppendFieldOnce(sharelink.FieldCollectionID)
	}
	query.Where(predicate.ShareLink(func(s *sql.Selector) {
		s.Where(sql.InValues(s.C(collection.SharesColumn), fks...))
	}))
	neighbors, err := query.All(ctx)
	if err != nil {
		return err
...
func (_q *CollectionQuery) loadCollectionAssets(ctx context.Context, query *CollectionAssetQuery, nodes []*Collection, init func(*Collection), assign func(*Collection, *CollectionAsset)) error {
	fks := make([]driver.Value, 0, len(nodes))
	nodeids := make(map[int]*Collection)
	for i := range nodes {
		fks = append(fks, nodes[i].ID)
	...
	if len(query.ctx.Fields) > 0 {
		query.ctx.AppendFieldOnce(collectionasset.FieldCollectionID)
	}
	query.Where(predicate.CollectionAsset(func(s *sql.Selector) {
		s.Where(sql.InValues(s.C(collection.CollectionAssetsColumn), fks...))
	}))
	neighbors, err := query.All(ctx)
	if err != nil {
		return err
...
func (_q *CollectionQuery) querySpec() *sqlgraph.QuerySpec {
	...
	if fields := _q.ctx.Fields; len(fields) > 0 {
		...
		if _q.withTrip != nil {
			_spec.Node.AddColumnOnce(collection.FieldTripID)
		}
	}
