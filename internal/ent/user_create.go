...
func (_c *UserCreate) AddCreatedTrips(v ...*Trip) *UserCreate {
	ids := make([]int, len(v))
	for i := range v {
		ids[i] = v[i].ID
	}
	return _c.AddCreatedTripIDs(ids...)
}

// AddEditorTripIDs adds the "editor_trips" edge to the Trip entity by IDs.
func (_c *UserCreate) AddEditorTripIDs(ids ...int) *UserCreate {
	_c.mutation.AddEditorTripIDs(ids...)
	return _c
}

// AddEditorTrips adds the "editor_trips" edges to the Trip entity.
func (_c *UserCreate) AddEditorTrips(v ...*Trip) *UserCreate {
	ids := make([]int, len(v))
	for i := range v {
		ids[i] = v[i].ID
	}
	return _c.AddEditorTripIDs(ids...)
}

// AddUploadedAssetIDs adds the "uploaded_assets" edge to the Asset entity by IDs.
func (_c *UserCreate) AddUploadedAssetIDs(ids ...int) *UserCreate {
	_c.mutation.AddUploadedAssetIDs(ids...)
	return _c
}

// AddUploadedAssets adds the "uploaded_assets" edges to the Asset entity.
func (_c *UserCreate) AddUploadedAssets(v ...*Asset) *UserCreate {
	ids := make([]int, len(v))
	for i := range v {
		ids[i] = v[i].ID
	}
	return _c.AddUploadedAssetIDs(ids...)
}

// AddShareIDs adds the "shares" edge to the ShareLink entity by IDs.
func (_c *UserCreate) AddShareIDs(ids ...int) *UserCreate {
	_c.mutation.AddShareIDs(ids...)
	return _c
}

// AddShares adds the "shares" edges to the ShareLink entity.
func (_c *UserCreate) AddShares(v ...*ShareLink) *UserCreate {
	ids := make([]int, len(v))
	for i := range v {
		ids[i] = v[i].ID
	}
...
func (_c *UserCreate) AddUploadGrantIDs(ids ...int) *UserCreate {
	_c.mutation.AddUploadGrantIDs(ids...)
	return _c
}

// AddUploadGrants adds the "upload_grants" edges to the UploadGrant entity.
func (_c *UserCreate) AddUploadGrants(v ...*UploadGrant) *UserCreate {
	ids := make([]int, len(v))
	for i := range v {
		ids[i] = v[i].ID
	}
...
func (_c *UserCreate) AddCredentials(v ...*UserCredential) *UserCreate {
	ids := make([]int, len(v))
	for i := range v {
		ids[i] = v[i].ID
	}
...
func (_c *UserCreate) AddTripEditorIDs(ids ...int) *UserCreate {
	_c.mutation.AddTripEditorIDs(ids...)
	return _c
}

// AddTripEditors adds the "trip_editors" edges to the TripEditor entity.
func (_c *UserCreate) AddTripEditors(v ...*TripEditor) *UserCreate {
	ids := make([]int, len(v))
	for i := range v {
		ids[i] = v[i].ID
	}
...
func (_c *UserCreate) createSpec() (*User, *sqlgraph.CreateSpec) {
	...
	if nodes := _c.mutation.EditorTripsIDs(); len(nodes) > 0 {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.M2M,
			Inverse: false,
	...
	if nodes := _c.mutation.UploadedAssetsIDs(); len(nodes) > 0 {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.O2M,
			Inverse: false,
