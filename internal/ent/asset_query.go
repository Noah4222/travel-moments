...
type AssetQuery struct {
	...
	withViews            *AssetViewQuery
	withComments         *CommentQuery
	withCollectionAssets *CollectionAssetQuery
...
func (_q *AssetQuery) QueryTrip() *TripQuery {
...
func (_q *AssetQuery) QueryUploadedBy() *UserQuery {
...
func (_q *AssetQuery) QueryCollections() *CollectionQuery {
...
func (_q *AssetQuery) QueryViews() *AssetViewQuery {
...
func (_q *AssetQuery) QueryComments() *CommentQuery {
...
// QueryCollectionAssets chains the current query on the "collection_assets" edge.
func (_q *AssetQuery) QueryCollectionAssets() *CollectionAssetQuery {
	query := (&CollectionAssetClient{config: _q.config}).Query()
	query.path = func(ctx context.Context) (fromU *sql.Selector, err error) {
		if err := _q.prepareQuery(ctx); err != nil {
			return nil, err
		}
...
func (_q *AssetQuery) Clone() *AssetQuery {
	...
	return &AssetQuery{
		...
		withCollectionAssets: _q.withCollectionAssets.Clone(),
...
func (_q *AssetQuery) WithTrip(opts ...func(*TripQuery)) *AssetQuery {
	query := (&TripClient{config: _q.config}).Query()
...
func (_q *AssetQuery) WithUploadedBy(opts ...func(*UserQuery)) *AssetQuery {
	query := (&UserClient{config: _q.config}).Query()
	for _, opt := range opts {
		opt(query)
	}
...
func (_q *AssetQuery) WithCollections(opts ...func(*CollectionQuery)) *AssetQuery {
	query := (&CollectionClient{config: _q.config}).Query()
	for _, opt := range opts {
		opt(query)
	}
...
func (_q *AssetQuery) WithViews(opts ...func(*AssetViewQuery)) *AssetQuery {
	query := (&AssetViewClient{config: _q.config}).Query()
	for _, opt := range opts {
		opt(query)
	}
...
func (_q *AssetQuery) WithComments(opts ...func(*CommentQuery)) *AssetQuery {
	query := (&CommentClient{config: _q.config}).Query()
	for _, opt := range opts {
		opt(query)
	}
...
// WithCollectionAssets tells the query-builder to eager-load the nodes that are connected to
// the "collection_assets" edge. The optional arguments are used to configure the query builder of the edge.
func (_q *AssetQuery) WithCollectionAssets(opts ...func(*CollectionAssetQuery)) *AssetQuery {
	query := (&CollectionAssetClient{config: _q.config}).Query()
	for _, opt := range opts {
		opt(query)
	}
	_q.withCollectionAssets = query
	return _q
}
...
func (_q *AssetQuery) sqlAll(ctx context.Context, hooks ...queryHook) ([]*Asset, error) {
	...
	if query := _q.withTrip; query != nil {
		if err := _q.loadTrip(ctx, query, nodes, nil,
			func(n *Asset, e *Trip) { n.Edges.Trip = e }); err != nil {
			return nil, err
		}
	}
	if query := _q.withUploadedBy; query != nil {
		if err := _q.loadUploadedBy(ctx, query, nodes, nil,
			func(n *Asset, e *User) { n.Edges.UploadedBy = e }); err != nil {
			return nil, err
		}
	}
	if query := _q.withCollections; query != nil {
		if err := _q.loadCollections(ctx, query, nodes,
			func(n *Asset) { n.Edges.Collections = []*Collection{} },
			func(n *Asset, e *Collection) { n.Edges.Collections = append(n.Edges.Collections, e) }); err != nil {
			return nil, err
		}
	}
	if query := _q.withViews; query != nil {
		if err := _q.loadViews(ctx, query, nodes,
			func(n *Asset) { n.Edges.Views = []*AssetView{} },
			func(n *Asset, e *AssetView) { n.Edges.Views = append(n.Edges.Views, e) }); err != nil {
			return nil, err
		}
	}
	if query := _q.withComments; query != nil {
		if err := _q.loadComments(ctx, query, nodes,
			func(n *Asset) { n.Edges.Comments = []*Comment{} },
			func(n *Asset, e *Comment) { n.Edges.Comments = append(n.Edges.Comments, e) }); err != nil {
			return nil, err
		}
	}
	if query := _q.withCollectionAssets; query != nil {
		if err := _q.loadCollectionAssets(ctx, query, nodes,
			func(n *Asset) { n.Edges.CollectionAssets = []*CollectionAsset{} },
			func(n *Asset, e *CollectionAsset) { n.Edges.CollectionAssets = append(n.Edges.CollectionAssets, e) }); err != nil {
			return nil, err
		}
	}
	return nodes, nil
...
func (_q *AssetQuery) loadTrip(ctx context.Context, query *TripQuery, nodes []*Asset, init func(*Asset), assign func(*Asset, *Trip)) error {
...
func (_q *AssetQuery) loadUploadedBy(ctx context.Context, query *UserQuery, nodes []*Asset, init func(*Asset), assign func(*Asset, *User)) error {
	ids := make([]int, 0, len(nodes))
	nodeids := make(map[int][]*Asset)
	for i := range nodes {
...
func (_q *AssetQuery) loadCollections(ctx context.Context, query *CollectionQuery, nodes []*Asset, init func(*Asset), assign func(*Asset, *Collection)) error {
	...
	query.Where(func(s *sql.Selector) {
		joinT := sql.Table(asset.CollectionsTable)
		s.Join(joinT).On(s.C(collection.FieldID), joinT.C(asset.CollectionsPrimaryKey[0]))
		s.Where(sql.InValues(joinT.C(asset.CollectionsPrimaryKey[1]), edgeIDs...))
		columns := s.SelectedColumns()
		s.Select(joinT.C(asset.CollectionsPrimaryKey[1]))
...
func (_q *AssetQuery) loadViews(ctx context.Context, query *AssetViewQuery, nodes []*Asset, init func(*Asset), assign func(*Asset, *AssetView)) error {
	...
	if len(query.ctx.Fields) > 0 {
		query.ctx.AppendFieldOnce(assetview.FieldAssetID)
	}
	query.Where(predicate.AssetView(func(s *sql.Selector) {
		s.Where(sql.InValues(s.C(asset.ViewsColumn), fks...))
	}))
	neighbors, err := query.All(ctx)
	if err != nil {
		return err
...
func (_q *AssetQuery) loadComments(ctx context.Context, query *CommentQuery, nodes []*Asset, init func(*Asset), assign func(*Asset, *Comment)) error {
	fks := make([]driver.Value, 0, len(nodes))
	nodeids := make(map[int]*Asset)
	for i := range nodes {
		fks = append(fks, nodes[i].ID)
	...
	if len(query.ctx.Fields) > 0 {
		query.ctx.AppendFieldOnce(comment.FieldAssetID)
	}
	query.Where(predicate.Comment(func(s *sql.Selector) {
		s.Where(sql.InValues(s.C(asset.CommentsColumn), fks...))
	}))
	neighbors, err := query.All(ctx)
	if err != nil {
		return err
...
func (_q *AssetQuery) loadCollectionAssets(ctx context.Context, query *CollectionAssetQuery, nodes []*Asset, init func(*Asset), assign func(*Asset, *CollectionAsset)) error {
	fks := make([]driver.Value, 0, len(nodes))
	nodeids := make(map[int]*Asset)
	for i := range nodes {
		fks = append(fks, nodes[i].ID)
	...
	if len(query.ctx.Fields) > 0 {
		query.ctx.AppendFieldOnce(collectionasset.FieldAssetID)
	}
	query.Where(predicate.CollectionAsset(func(s *sql.Selector) {
		s.Where(sql.InValues(s.C(asset.CollectionAssetsColumn), fks...))
	}))
	neighbors, err := query.All(ctx)
	if err != nil {
		return err
...
func (_q *AssetQuery) querySpec() *sqlgraph.QuerySpec {
	...
	if fields := _q.ctx.Fields; len(fields) > 0 {
		...
		if _q.withTrip != nil {
			_spec.Node.AddColumnOnce(asset.FieldTripID)
		}
		if _q.withUploadedBy != nil {
			_spec.Node.AddColumnOnce(asset.FieldUploadedByID)
		}
	}
