...
func checkColumn(t, c string) error {
	initCheck.Do(func() {
		columnCheck = sql.NewColumnCheck(map[string]func(string) bool{
			...
			assetview.Table:       assetview.ValidColumn,
			auditlog.Table:        auditlog.ValidColumn,
			collection.Table:      collection.ValidColumn,
			collectionasset.Table: collectionasset.ValidColumn,
			comment.Table:         comment.ValidColumn,
			sharelink.Table:       sharelink.ValidColumn,
			sharetrip.Table:       sharetrip.ValidColumn,
			trip.Table:            trip.ValidColumn,
			tripeditor.Table:      tripeditor.ValidColumn,
			uploadgrant.Table:     uploadgrant.ValidColumn,
