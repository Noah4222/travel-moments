...
// The AssetViewFunc type is an adapter to allow the use of ordinary
// function as AssetView mutator.
type AssetViewFunc func(context.Context, *ent.AssetViewMutation) (ent.Value, error)

// Mutate calls f(ctx, m).
func (f AssetViewFunc) Mutate(ctx context.Context, m ent.Mutation) (ent.Value, error) {
	if mv, ok := m.(*ent.AssetViewMutation); ok {
		return f(ctx, mv)
	}
	return nil, fmt.Errorf("unexpected mutation type %T. expect *ent.AssetViewMutation", m)
}
...
// The CollectionAssetFunc type is an adapter to allow the use of ordinary
// function as CollectionAsset mutator.
type CollectionAssetFunc func(context.Context, *ent.CollectionAssetMutation) (ent.Value, error)

// Mutate calls f(ctx, m).
func (f CollectionAssetFunc) Mutate(ctx context.Context, m ent.Mutation) (ent.Value, error) {
	if mv, ok := m.(*ent.CollectionAssetMutation); ok {
		return f(ctx, mv)
	}
	return nil, fmt.Errorf("unexpected mutation type %T. expect *ent.CollectionAssetMutation", m)
}
...
// The ShareTripFunc type is an adapter to allow the use of ordinary
// function as ShareTrip mutator.
type ShareTripFunc func(context.Context, *ent.ShareTripMutation) (ent.Value, error)

// Mutate calls f(ctx, m).
func (f ShareTripFunc) Mutate(ctx context.Context, m ent.Mutation) (ent.Value, error) {
	if mv, ok := m.(*ent.ShareTripMutation); ok {
		return f(ctx, mv)
	}
	return nil, fmt.Errorf("unexpected mutation type %T. expect *ent.ShareTripMutation", m)
}
...
// The TripEditorFunc type is an adapter to allow the use of ordinary
// function as TripEditor mutator.
type TripEditorFunc func(context.Context, *ent.TripEditorMutation) (ent.Value, error)

// Mutate calls f(ctx, m).
func (f TripEditorFunc) Mutate(ctx context.Context, m ent.Mutation) (ent.Value, error) {
	if mv, ok := m.(*ent.TripEditorMutation); ok {
		return f(ctx, mv)
	}
	return nil, fmt.Errorf("unexpected mutation type %T. expect *ent.TripEditorMutation", m)
}

// The UploadGrantFunc type is an adapter to allow the use of ordinary
// function as UploadGrant mutator.
type UploadGrantFunc func(context.Context, *ent.UploadGrantMutation) (ent.Value, error)

// Mutate calls f(ctx, m).
func (f UploadGrantFunc) Mutate(ctx context.Context, m ent.Mutation) (ent.Value, error) {
	if mv, ok := m.(*ent.UploadGrantMutation); ok {
		return f(ctx, mv)
	}
	return nil, fmt.Errorf("unexpected mutation type %T. expect *ent.UploadGrantMutation", m)
}
