...
func (_q *UserCredentialQuery) QueryUser() *UserQuery {
	...
	query.path = func(ctx context.Context) (fromU *sql.Selector, err error) {
		...
		step := sqlgraph.NewStep(
			sqlgraph.From(usercredential.Table, usercredential.FieldID, selector),
...
func (_q *UserCredentialQuery) WithUser(opts ...func(*UserQuery)) *UserCredentialQuery {
	query := (&UserClient{config: _q.config}).Query()
...
func (_q *UserCredentialQuery) sqlAll(ctx context.Context, hooks ...queryHook) ([]*UserCredential, error) {
	...
	if query := _q.withUser; query != nil {
		if err := _q.loadUser(ctx, query, nodes, nil,
			func(n *UserCredential, e *User) { n.Edges.User = e }); err != nil {
			return nil, err
		}
	}
	return nodes, nil
...
func (_q *UserCredentialQuery) loadUser(ctx context.Context, query *UserQuery, nodes []*UserCredential, init func(*UserCredential), assign func(*UserCredential, *User)) error {
	ids := make([]int, 0, len(nodes))
	nodeids := make(map[int][]*UserCredential)
	for i := range nodes {
		fk := nodes[i].UserID
...
func (_q *UserCredentialQuery) querySpec() *sqlgraph.QuerySpec {
	...
	if fields := _q.ctx.Fields; len(fields) > 0 {
		...
		if _q.withUser != nil {
			_spec.Node.AddColumnOnce(usercredential.FieldUserID)
		}
	}
